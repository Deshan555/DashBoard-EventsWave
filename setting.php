    ...
    <!-- Sidebar -->
        ...
        <div class="container">
		 <?php
		       	...
		       	?>
        <form action="changepassword.php" method="post" class="border border-2 m-4 p-3">
            <div class="row">
                <h3>Change the Passsword</h3>
                <div class="col">
                    <label for="pswd">NewPassword:</label>
                    <input type="password" class="form-control" placeholder="Enter password" name="pswd" required>
                </div>
                <div class="col">
                    <label for="password">ReEnterPassword:</label>
                    <input type="password" class="form-control" placeholder="Enter password" name="password" required>
                </div>
            </div>
            <div class="row">
                <div class="col-6">
                <label for="currentpaswd">CurrentPassword:</label>
                <input type="password" class="form-control" placeholder="Enter Your current password" name="pswdcurrentpaswd" id="currentpaswd" required>
                </div>
            </div>
            <div class="row">
                <div class="col">
        ...
        <form action="addnewadmin.php" method="post" class="border border-2 m-4 p-3">    
            <div class="row">
                <h3>Add new Admin</h3>
                <div class="col">
            ...
            <div class="row">
                <div class="col">
                    <button type="submit" class="btn btn-primary mt-3" name="addadmin">Submit</button>
                </div>
            </div>
        </form>
    </div>
